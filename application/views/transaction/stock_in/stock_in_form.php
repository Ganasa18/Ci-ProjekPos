    ...
    <div class="row">
      <div class="card card-info col-lg-5 mx-auto">
        <div class="card-header">
          <h3 class="card-title"> Tambah Stock </h3>
        </div>
        <form class="form-horizontal" action="<?= site_url('stock/process') ?>" method="post">
          ...
          <div class="card-footer">
            <a href="<?= site_url('stock/stock_in_data'); ?>" class="btn btn-primary"><i class="fa fa-undo"></i> Kembali </a>
            <button type="submit" name="in_add" class="btn btn-success float-right"><i class="fa fa-user-plus"></i> Tambah Data </button>
