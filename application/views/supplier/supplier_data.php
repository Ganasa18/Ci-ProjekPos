       ...
       <div class="card col-lg sm-6 md-6 ml-3">
         ...
         <div class="card-body">
           <div class="mb-3 float-right">
             <a href="<?= site_url('supplier/add') ?>" class="btn btn-primary"><i class="fa fa-user-plus"></i> Tambah Data </a>
           </div>
               ...
               <tbody>
                 ...
                 <?php foreach ($supplier->result() as $key => $data) : ?>
                   <tr>
                     ...
                     <td width="250px">
                       <a href="<?= site_url('supplier/edit/' . $data->supplier_id) ?>" class="btn btn-warning "><i class="fas fa-edit"></i> Update </a>
