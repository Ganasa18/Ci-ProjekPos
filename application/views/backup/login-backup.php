...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?= base_url() ?>vendor/adminlte/index2.html"><b>Admin</b> Projek-POS</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      ...
      <div class="card-body login-card-body">
        ...
        <form action="<?= base_url('auth/login') ?>" method="post">
          ...
          <div class="row text-center">
            <div class="col-sm-6">
              <small class="text-success">username : admin</small>
            </div>
            <div class="col-sm-6">
              <small class="text-success">password : 123456</small>
            </div>
          </div>
        </form>
        <hr>
